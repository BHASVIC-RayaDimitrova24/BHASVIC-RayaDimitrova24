# C-Chapter2-Selection
This chapter focuses on selection in C, using if Statements. 

Selection allows the program to execute different code depending on input, result of calculation etc.
...
+ Student Work - Chapter 2a - ifStatements.pptx **(Start Here)**
+ Student Work - Chapter 2b - ifStatements ANDOR.pptx **(Then do this)**
+ Supporting Documentation - Chapter 2.pptx **(Read this fully)**
+ Starter Code - Chapter 2a.c **(This is the code for the first PRIMM)**
+ Starter Code - Chapter 2b.c **(This is the code for the second PRIMM)**
